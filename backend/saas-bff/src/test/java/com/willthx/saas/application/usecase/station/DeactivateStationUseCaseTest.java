...
class DeactivateStationUseCaseTest {

    @Mock IotCoreFeignClient iotCoreClient;
    @InjectMocks DeactivateStationUseCase useCase;
    ...
    @Test
    void execute_deactivates_station_for_admin() {
        ...
        given(iotCoreClient.deactivateStation(1L, 10L)).willReturn(response);
