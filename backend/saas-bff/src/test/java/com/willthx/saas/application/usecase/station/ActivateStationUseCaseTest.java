...
class ActivateStationUseCaseTest {

    @Mock IotCoreFeignClient iotCoreClient;
    @InjectMocks ActivateStationUseCase useCase;
    ...
    @Test
    void execute_activates_station_for_admin() {
        ...
        given(iotCoreClient.activateStation(1L, 10L)).willReturn(response);
