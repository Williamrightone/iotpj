...
class CreateStationComponentUseCaseTest {

    @Mock IotCoreFeignClient iotCoreClient;
    @InjectMocks CreateStationComponentUseCase useCase;
    ...
    @Test
    void execute_admin_creates_station_component() {
        UserContextHolder.set(ctx(Role.ADMIN));
        CreateComponentRq rq = new CreateComponentRq("C001", "Comp1", "EVENT", null, null, null, null);
        ...
        given(iotCoreClient.createStationComponent(5L, 10L, rq)).willReturn(response);
    ...
    void execute_viewer_throws_FORBIDDEN() {
        ...
        assertThatThrownBy(() -> useCase.execute(5L,
