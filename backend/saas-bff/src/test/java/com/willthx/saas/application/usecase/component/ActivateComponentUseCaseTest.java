...
class ActivateComponentUseCaseTest {

    @Mock IotCoreFeignClient iotCoreClient;
    @InjectMocks ActivateComponentUseCase useCase;
    ...
    @Test
    void execute_activates_component_for_admin() {
        ...
        given(iotCoreClient.activateComponent(1L, 10L)).willReturn(response);
